...
namespace MemoryProfilerWindow
{
    public class MemoryProfilerWindow : EditorWindow
    {
        ...
        private bool _enableCrawl = false;
        ...
        void OnGUI()
        {
            ...
            _enableCrawl = GUILayout.Toggle(_enableCrawl, "EnableCrawl");
        ...
        void IncomingSnapshot(PackedMemorySnapshot snapshot)
        {
            ...
            {
                Debug.Log("snapshot is captured, but crawl is disabled, new SnapshotHash=" + _snapshot.GetHashCode());
            }
        }
    }
}
