...
public static class PackedMemorySnapshotUtility
{
    ...
    static void SaveToFile(string filePath, PackedMemorySnapshot snapshot)
    {
        ...
        Debug.LogFormat("Saving...SnapshotHash=" + snapshot.GetHashCode() + " at " + filePath);
        ...
        stopwatch.Stop();
        Profiler.EndSample();
        Debug.LogFormat("Saved snapshot, SnapshotHash=" + snapshot.GetHashCode() + " at " + filePath + ", took {0}ms", stopwatch.ElapsedMilliseconds);
    }
